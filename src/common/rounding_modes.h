...
inline const std::unordered_map<std::string, RoundingMode> stringToRoundingMode = {
    {"rne", RoundingMode::RNE}, {"rtz", RoundingMode::RTZ}, {"rdn", RoundingMode::RDN},
    {"rup", RoundingMode::RUP}, {"rmm", RoundingMode::RMM}, {"dyn", RoundingMode::DYN}};

inline const std::unordered_map<RoundingMode, int> roundingModeEncoding = {
    {RoundingMode::RNE, 0b000}, {RoundingMode::RTZ, 0b001}, {RoundingMode::RDN, 0b010},
    {RoundingMode::RUP, 0b011}, {RoundingMode::RMM, 0b100}, {RoundingMode::DYN, 0b111}};
