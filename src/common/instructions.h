...
//here we are usign kname because this is googles convention for enum
//vishank used it god knows why and i am too lazy to change it
...
struct InstructionEncoding
{
    ...
    InstructionEncoding(int opcode, int funct2, int funct3, int funct5, int funct6, int funct7)
        : opcode(opcode), funct2(funct2), funct3(funct3), funct5(funct5), funct6(funct6),
          funct7(funct7)
    {
    }
};
...
struct UTypeInstructionEncoding
{
    ...
    UTypeInstructionEncoding(unsigned int opcode) : opcode(opcode)
    {
    }
};
...
struct JTypeInstructionEncoding
{
    ...
    JTypeInstructionEncoding(unsigned int opcode) : opcode(opcode)
    {
    }
};
...
struct FDRTypeInstructionEncoding
{ // fsgnj
    std::bitset<7> opcode;
    std::bitset<3> funct3;
    std::bitset<7> funct7;
...
struct FDR1TypeInstructionEncoding
{ // fadd, fsub, fmul
    std::bitset<7> opcode;
    std::bitset<7> funct7;
...
struct FDR2TypeInstructionEncoding
{ // fsqrt, have funct5 instead of rs2
    std::bitset<7> opcode;
    std::bitset<5> funct5;
    std::bitset<7> funct7;
...
struct FDR3TypeInstructionEncoding
{
    ...
    FDR3TypeInstructionEncoding(unsigned int opcode, unsigned int funct3, unsigned int funct5,
                                unsigned int funct7)
...
struct FDR4TypeInstructionEncoding
{ // fmadd
    std::bitset<7> opcode;
    std::bitset<2> funct2;
...
enum class SyntaxType
{
    ...
    O_FPR_C_FPR_C_FPR_C_FPR_C_RM, ///< Opcode floating-point-register , floating-point-register ,
                                  ///< floating-point-register , rounding_mode
    O_FPR_C_FPR_C_FPR,            ///< Opcode floating-point-register , floating-point-register ,
                                  ///< floating-point-register
    O_FPR_C_FPR_C_FPR_C_RM,       ///< Opcode floating-point-register , floating-point-register ,
                                  ///< floating-point-register , rounding_mode
    ...
    O_GPR_C_FPR_C_FPR,   ///< Opcode general-register , floating-point-register ,
                         ///< floating-point-register
    O_FPR_C_I_LP_GPR_RP, ///< Opcode floating-point-register , immediate , lparen ( general-register
                         ///< ) rparen
};
...
extern std::unordered_map<std::string, CSR_RTypeInstructionEncoding>
    CSR_R_type_instruction_encoding_map;
extern std::unordered_map<std::string, CSR_ITypeInstructionEncoding>
    CSR_I_type_instruction_encoding_map;

extern std::unordered_map<std::string, FDRTypeInstructionEncoding>
    F_D_R_type_instruction_encoding_map;
extern std::unordered_map<std::string, FDR1TypeInstructionEncoding>
    F_D_R1_type_instruction_encoding_map;
extern std::unordered_map<std::string, FDR2TypeInstructionEncoding>
    F_D_R2_type_instruction_encoding_map;
extern std::unordered_map<std::string, FDR3TypeInstructionEncoding>
    F_D_R3_type_instruction_encoding_map;
extern std::unordered_map<std::string, FDR4TypeInstructionEncoding>
    F_D_R4_type_instruction_encoding_map;
extern std::unordered_map<std::string, FDITypeInstructionEncoding>
    F_D_I_type_instruction_encoding_map;
extern std::unordered_map<std::string, FDSTypeInstructionEncoding>
    F_D_S_type_instruction_encoding_map;
