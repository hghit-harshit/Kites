...
std::ostream &operator<<(std::ostream &os, const SyntaxError &error)
{
    os << error.filename << ":" << error.line_number << ":" << error.column_number << ": "
       << ANSI_code_red << "[ERROR]" << ANSI_code_reset << " " << error.main_message << "\n"
       << std::setw(6) << std::right << error.line_number << " | " << error.line_text << "\n"
       << std::setw(6) << " " << " | " << ANSI_code_red << std::setw(error.column_number)
       << std::right << "^" << ANSI_code_reset << "\n"
...
{
    os << error.filename << ":" << error.line_number << ":" << error.column_number << ": "
       << ANSI_code_red << "[ERROR]" << ANSI_code_reset << " " << error.message << "\n"
       << std::setw(6) << std::right << error.line_number << " | " << error.line_text << "\n"
       << std::setw(6) << " " << " | " << ANSI_code_red << std::setw(error.column_number)
       << std::right << "^" << ANSI_code_reset << "\n"
       << std::setw(6) << " " << " | " << "\n"
