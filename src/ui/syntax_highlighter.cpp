...
void SyntaxHighlighter::setHighlightingRules()
{
    ...
    const QStringList riscvRegisterPatterns = {
        // --- Numeric registers ---
        "\\bx0\\b", "\\bx1\\b", "\\bx2\\b", "\\bx3\\b", "\\bx4\\b", "\\bx5\\b", "\\bx6\\b",
        "\\bx7\\b", "\\bx8\\b", "\\bx9\\b", "\\bx10\\b", "\\bx11\\b", "\\bx12\\b", "\\bx13\\b",
        "\\bx14\\b", "\\bx15\\b", "\\bx16\\b", "\\bx17\\b", "\\bx18\\b", "\\bx19\\b", "\\bx20\\b",
        "\\bx21\\b", "\\bx22\\b", "\\bx23\\b", "\\bx24\\b", "\\bx25\\b", "\\bx26\\b", "\\bx27\\b",
        "\\bx28\\b", "\\bx29\\b", "\\bx30\\b", "\\bx31\\b",

        // --- ABI names ---
        "\\bzero\\b", "\\bra\\b", "\\bsp\\b", "\\bgp\\b", "\\btp\\b", "\\bt0\\b", "\\bt1\\b",
        "\\bt2\\b", "\\bs0\\b", "\\bs1\\b", "\\ba0\\b", "\\ba1\\b", "\\ba2\\b", "\\ba3\\b",
        "\\ba4\\b", "\\ba5\\b", "\\ba6\\b", "\\ba7\\b", "\\bs2\\b", "\\bs3\\b", "\\bs4\\b",
        "\\bs5\\b", "\\bs6\\b", "\\bs7\\b", "\\bs8\\b", "\\bs9\\b", "\\bs10\\b", "\\bs11\\b",
        "\\bt3\\b", "\\bt4\\b", "\\bt5\\b", "\\bt6\\b",

        // --- Floating-point registers (F extension) ---
        "\\bf0\\b", "\\bf1\\b", "\\bf2\\b", "\\bf3\\b", "\\bf4\\b", "\\bf5\\b", "\\bf6\\b",
        "\\bf7\\b", "\\bf8\\b", "\\bf9\\b", "\\bf10\\b", "\\bf11\\b", "\\bf12\\b", "\\bf13\\b",
        "\\bf14\\b", "\\bf15\\b", "\\bf16\\b", "\\bf17\\b", "\\bf18\\b", "\\bf19\\b", "\\bf20\\b",
        "\\bf21\\b", "\\bf22\\b", "\\bf23\\b", "\\bf24\\b", "\\bf25\\b", "\\bf26\\b", "\\bf27\\b",
        "\\bf28\\b", "\\bf29\\b", "\\bf30\\b", "\\bf31\\b"};
    ...
    m_highlightRules.append({QRegularExpression(R"(^\s*[A-Za-z_][A-Za-z0-9_.$]*:$)"), []()
                             {
                                 QTextCharFormat format;
    ...
    // for number literals
    m_highlightRules.append({QRegularExpression(R"(\b0[xX][0-9a-fA-F]+|\b\d+|\b0[bB][01]+)"), []()
                             {
                                 QTextCharFormat format;
