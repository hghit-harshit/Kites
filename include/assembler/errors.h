/**
 * @file errors.h
 * @brief Defines error handling structures and error types for syntax and semantic errors in the
 * assembler.
...
struct SyntaxError
{
    ...
    SyntaxError(std::string main_message, std::string sub_message, std::string filename,
                unsigned int line_number, unsigned int column_number, std::string line_text)
...
struct UnexpectedTokenError
{
    ...
    UnexpectedTokenError(std::string message, std::string filename, unsigned int line_number,
...
struct ImmediateOutOfRangeError
{
    ...
    ImmediateOutOfRangeError(std::string main_message, std::string sub_message,
                             std::string filename, unsigned int line_number,
                             unsigned int column_number, std::string line_text)
        : main_message(std::move(main_message)), sub_message(std::move(sub_message)),
          filename(std::move(filename)), line_number(line_number), column_number(column_number),
          line_text(std::move(line_text))
...
struct MisalignedImmediateError
{
    ...
    MisalignedImmediateError(std::string main_message, std::string sub_message,
                             std::string filename, unsigned int line_number,
                             unsigned int column_number, std::string line_text)
        : main_message(std::move(main_message)), sub_message(std::move(sub_message)),
          filename(std::move(filename)), line_number(line_number), column_number(column_number),
...
struct UnexpectedOperandError
{
    ...
    UnexpectedOperandError(std::string main_message, std::string sub_message, std::string filename,
...
struct InvalidLabelRefError
{
    ...
    InvalidLabelRefError(std::string main_message, std::string sub_message, std::string filename,
                         unsigned int line_number, unsigned int column_number,
                         std::string line_text)
        : main_message(std::move(main_message)), sub_message(std::move(sub_message)),
          filename(std::move(filename)), line_number(line_number), column_number(column_number),
...
struct LabelRedefinitionError
{
    ...
    LabelRedefinitionError(std::string main_message, std::string sub_message, std::string filename,
                           unsigned int line_number, unsigned int column_number,
                           std::string line_text)
        : main_message(std::move(main_message)), sub_message(std::move(sub_message)),
          filename(std::move(filename)), line_number(line_number), column_number(column_number),
...
struct InvalidRegisterError
{
    ...
    InvalidRegisterError(std::string main_message, std::string sub_message, std::string filename,
                         unsigned int line_number, unsigned int column_number,
                         std::string line_text)
        : main_message(std::move(main_message)), sub_message(std::move(sub_message)),
          filename(std::move(filename)), line_number(line_number), column_number(column_number),
