 ...
 * It allows users to add new pseudo instructions and their expansions, which can then be used in
 * assembly code. The class will handle the storage and retrieval of these custom pseudo
 * instructions, as well as any necessary validation.
 *
 */
class CustomPseudoManager
{
  public:
    ...
    static bool parse(ParsedPseudoInstruction &parsedInst, const QString &pseudoInst,
                      const QString &expansion, QString &errorMessage);
    static bool validatePseudoInstruction(const ParsedPseudoInstruction &parsedInst,
                                          QString &errorMessage);
    static bool isValidExpainsionLine(const QString &line, const QStringList &declaredArgs,
                                      QString &errorMessage);
    ...
    static bool updateCustomPseudoInstruction(const QString &pseudoInst,
